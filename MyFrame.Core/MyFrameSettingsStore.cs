...
public static class MyFrameStoragePaths
{
    ...
    public static string DataDatabasePath => Path.Combine(RootDirectory, "data.db");
    public static string CollectorCaptureDirectory => Path.Combine(RootDirectory, "captures");
