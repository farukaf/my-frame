...
3. Consulte `get_activity`/`list_current_bounties` quando disponíveis e preserve a revisão World State.
4. Relacione cada recompensa a sua fonte, tier, chance, quantidade e condição. Chance não é garantia.
5. Compare alternativas por restrições do usuário (solo, tempo, MR, equipamento, rotação), sem converter chance em tokens/hora.
