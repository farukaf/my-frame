...
public sealed class McpFeatureTests(ITestOutputHelper output)
{
    ...
    public void EveryToolIsExplicitlyReadOnlyAndHasThePlannedName()
    {
        ...
        var expected = new[] { "get_capabilities", "get_capture_inbox_status", "get_item", "get_overview", "get_sync_status", "list_collection", "list_farm", "list_relics", "list_sales", "list_surplus", "search_inventory" };
