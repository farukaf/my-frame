...
| WF3 | [WarframeStat.us API](https://api.warframestat.us/pc) | Endpoint comunitário respondeu HTTP 200 em 13/09/2026; snapshot observado contém `syndicateMissions`, ciclos e `rewardPoolDrops`, mas não campo explícito de Mother Tokens. Usar atribuição e revisão separadas; não tratar como dado oficial da DE. |
