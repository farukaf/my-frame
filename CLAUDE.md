...
For farm questions, follow `skills/warframe-farm/SKILL.md`; for build questions,
follow `skills/warframe-builds/SKILL.md`. Keep source revisions, coverage and
freshness in the answer and never invent a build, tokens/hour, or ownership.
